 ...
 * on 2016.09.10:49
 */
public class HqEditListAdapter extends MultiItemRecycleViewAdapter<NewsFavBean.Favorite> {

    OnDeleteBtnClickListener mClickListener;

    public HqEditListAdapter(Context context, final List<NewsFavBean.Favorite> datas, OnDeleteBtnClickListener clickListener) {
