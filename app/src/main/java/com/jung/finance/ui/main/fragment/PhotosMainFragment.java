...
import com.jung.finance.bean.PhotoGirl;
import com.jung.finance.ui.news.activity.PhotosDetailActivity;
import com.jung.finance.ui.news.contract.PhotoListContract;
import com.jung.finance.ui.news.model.PhotosListModel;
import com.jung.finance.ui.news.presenter.PhotosListPresenter;
        ...
        adapter=new CommonRecycleViewAdapter<PhotoGirl>(getContext(),R.layout.item_photo) {
            ...
            public void convert(ViewHolderHelper helper,final PhotoGirl photoGirl) {
                ...
                Glide.with(mContext).load(photoGirl.getUrl())
                        ...
                        .placeholder(com.leon.common.R.drawable.ic_image_loading)
                        .error(com.leon.common.R.drawable.ic_empty_picture)
