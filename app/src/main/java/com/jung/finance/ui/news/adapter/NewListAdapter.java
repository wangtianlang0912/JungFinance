...
public class NewListAdapter extends MultiItemRecycleViewAdapter<ArticleModel.Article> {
     ...
     * @param position
     */
    private void setPhotoItemValues(ViewHolderHelper holder, final ArticleModel.Article article, int position) {
        ...
        setImageView(holder, article);
        holder.setOnClickListener(R.id.ll_root, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NewsPhotoDetailActivity.startAction(mContext, getPhotoDetail(article));
            }
        });
    }

    private NewsPhotoDetail getPhotoDetail(ArticleModel.Article article) {
        NewsPhotoDetail newsPhotoDetail = new NewsPhotoDetail();
        newsPhotoDetail.setTitle(article.getTitle());
        setPictures(article, newsPhotoDetail);
        return newsPhotoDetail;
    }

    private void setPictures(ArticleModel.Article article, NewsPhotoDetail newsPhotoDetail) {
...
//        }
    ...
    private void setImageView(ViewHolderHelper holder, ArticleModel.Article article) {
