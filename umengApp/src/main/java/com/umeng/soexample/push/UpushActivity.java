...
public class UpushActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initClickListener() {
        inputTag = (EditText) findViewById(R.id.etx_input_tag);
        inputWeightedTag = (EditText) findViewById(R.id.etx_input_weighted_tag);
        inputWeightedTagValue = (EditText) findViewById(R.id.etx_input_weighted_tag_value);
        inputAlias = (EditText) findViewById(R.id.etx_input_alias);
        inputAliasType = (EditText) findViewById(R.id.etx_input_alias_type);
        tagRemain = (TextView) findViewById(R.id.tv_tag_remain);
