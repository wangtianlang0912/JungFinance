...
public class PushDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (viewType == 0) {
            ...
            ImageView ivIcon = (ImageView) v.findViewById(R.id.push_dialog_icon);
            TextView tvTitle = (TextView) v.findViewById(R.id.push_dialog_title);
            TextView tvText = (TextView) v.findViewById(R.id.push_dialog_text);
        ...
        if (viewType == 1) {
            ...
            TextView tl = (TextView) v.findViewById(R.id.push_dialog_title);
            TextView tx = (TextView) v.findViewById(R.id.push_dialog_text);
            tl.setText(title);
            tx.setText(text);
