...
public class SettingActivity extends Activity{
    ...
    private void initViews(){
        ...
        if (style.startsWith(StyleUtil.TEXT)){
            ...
            btnGroup.setLayoutParams(lp);
            final EditText imgText = (EditText) findViewById(R.id.localimg_input);
            final EditText thumbText = (EditText) findViewById(R.id.localimg_input_thumb);
            ...
            btnGroup.setLayoutParams(lp);
            final EditText imgText = (EditText) findViewById(R.id.netimg_input);
            final EditText thumbText = (EditText) findViewById(R.id.netimg_input_thumb);
            sendBtn.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    String text = imgText.getText().toString();
            ...
            btnGroup.setLayoutParams(lp);
            final EditText titleText = (EditText) findViewById(R.id.net_title);
            final EditText descText = (EditText) findViewById(R.id.net_desc);
            final EditText urlText = (EditText) findViewById(R.id.net_url);
            final EditText thumbText = (EditText) findViewById(R.id.net_thumb);
            sendBtn.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
