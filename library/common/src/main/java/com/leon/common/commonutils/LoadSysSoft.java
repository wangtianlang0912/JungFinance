package com.leon.common.commonutils;
...
public class LoadSysSoft {
    ...
    public boolean saveToCamenaAlbum(Context context, String fileSaveName,
        ...
        final Uri STORAGE_URI = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
        final String IMAGE_MIME_TYPE = "image/jpeg";
        ContentValues values = new ContentValues(6);
        ContentResolver contentResolver = context.getContentResolver();
        values.put(MediaStore.Images.Media.TITLE, fileSaveName);
        values.put(MediaStore.Images.Media.DISPLAY_NAME, fileSaveName);
