...
//					+ (i - mid + 1 / 2) * pageSize-(numPages/2*pageSize+pageSize/2);

            result = getWidth()/2 -(getCircleRadius()*2*numPages+getPageWidth()*numPages)/2+ i*(getPageWidth()+2 * getCircleRadius());
