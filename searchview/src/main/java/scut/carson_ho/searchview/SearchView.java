...
public class SearchView extends LinearLayout {
    ...
    public void setHistoryViewVisible(boolean visible) {
    ...
    public void setOnClickClear(bCallBack bCallBack) {
        this.cCallBack = bCallBack;
    }
